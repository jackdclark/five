...
assert.equal(JSON.stringify(['Citrus', 'Passionate Peach', 'Berry Blast', 'Tropical', 'Pomegranate', 'Invigorating Blend', 'Winter Crop']), JSON.stringify(five.alive()), 'Five Alive should be all their varieties of juice');

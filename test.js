...
assert.equal(JSON.stringify(['Earth', 'Water', 'Fire', 'Wind', 'Void']), JSON.stringify(five.elements()), 'The five elements philosophy in Japanese Buddhism, derived from Buddhist beliefs');

...
assert.deepEqual(["Sight", "Hearing", "Taste", "Smell", "Touch"], five.senses(), 'The five senses are the traditionally recognized physiological capacities of organisms that provide data for perception');

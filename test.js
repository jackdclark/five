...
assert.equal(JSON.stringify(["Samuel Anders","Galen Tyrol","Tory Foster","Saul Tigh","Ellen Tigh"]), JSON.stringify(five.final()), 'The final five are the "unknown" five Cylon humanoid models');

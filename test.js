...
assert.equal(JSON.stringify(["Sight", "Hearing", "Taste", "Smell", "Touch"]), JSON.stringify(five.senses()), 'The five senses are the traditionally recognized physiological capacities of organisms that provide data for perception');
